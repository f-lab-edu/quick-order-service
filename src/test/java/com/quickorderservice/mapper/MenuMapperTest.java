...
class MenuMapperTest {
    ...
    void before() {
        ...
        RestaurantDTO restaurant = new RestaurantDTO(1L, 1L, "res", "-", "분당구 불정로 6", 0, 0, null, null, null);
        restaurantService.registerRestaurant(owner.getUid(), restaurant);
        this.restaurant = restaurantService.getRestaurantsByOwnerId(owner.getUid()).get(0);
    }

    @Test
    @DisplayName("정상적으로 메뉴 등록시 1을 반환한다.")
    void insertMenu() {
        MenuDTO menu = new MenuDTO(null, 0, "menu", 100, 100, null, null);
